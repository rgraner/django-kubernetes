...
- Image update:
```
kubectl set image deployment/django-k8s-web-deployment django-k8s-web=registry.digitalocean.com/rgraner-k8s/django-k8s-web:latest
```
...
Change 
```
image: registry.digitalocean.com/rgraner-k8s/django-k8s-web:latest
```
to
```
image: registry.digitalocean.com/rgraner-k8s/django-k8s-web:v1 
```
